...
class SettleExcelController extends AdminbaseController
{
	...
	public function get_all($index_sign,$life_sign,$non_life_sign,$renewal_sign,$file_name){
        ...
        /*设置居中*/
        $objPHPExcel->getActiveSheet(0)->getStyle('A1:J1')->getAlignment()->setHorizontal(\PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        /*设置字体*/
        $objPHPExcel->getActiveSheet(0)->getStyle('A1:J1')->getFont()->setName('微软雅黑'); 
        /*设置行高*/
        ...
        /*设置表格边框*/
        $objPHPExcel->getActiveSheet(0)->getStyle('A1:J'.$i)->getBorders()->getAllBorders()->setBorderStyle(\PHPExcel_Style_Border::BORDER_THIN);  
        ...
        /*设置居中*/
        $objPHPExcel->getActiveSheet(1)->getStyle('A1:J1')->getAlignment()->setHorizontal(\PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        /*设置字体*/
        $objPHPExcel->getActiveSheet(1)->getStyle('A1:J1')->getFont()->setName('微软雅黑'); 
        /*设置行高*/
        ...
        $a = $a-1;
        /*设置表格边框*/
        $objPHPExcel->getActiveSheet(1)->getStyle('A1:J'.$a)->getBorders()->getAllBorders()->setBorderStyle(\PHPExcel_Style_Border::BORDER_THIN);  
        ...
        /*设置居中*/
        $objPHPExcel->getActiveSheet(2)->getStyle('A1:J1')->getAlignment()->setHorizontal(\PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        /*设置字体*/
        $objPHPExcel->getActiveSheet(2)->getStyle('A1:J1')->getFont()->setName('微软雅黑'); 
        /*设置行高*/
        $objPHPExcel->getActiveSheet(2)->getRowDimension(1)->setRowHeight(30);
        ...
        $b = $b-1;
        /*设置表格边框*/
        $objPHPExcel->getActiveSheet(2)->getStyle('A1:H'.$b)->getBorders()->getAllBorders()->setBorderStyle(\PHPExcel_Style_Border::BORDER_THIN);  
        ...
        /*设置居中*/
        $objPHPExcel->getActiveSheet(3)->getStyle('A1:J1')->getAlignment()->setHorizontal(\PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        /*设置字体*/
        $objPHPExcel->getActiveSheet(3)->getStyle('A1:J1')->getFont()->setName('微软雅黑'); 
        /*设置行高*/
        $objPHPExcel->getActiveSheet(3)->getRowDimension(1)->setRowHeight(30);
        ...
        $c = $c-1;
        /*设置表格边框*/
        $objPHPExcel->getActiveSheet(3)->getStyle('A1:J'.$c)->getBorders()->getAllBorders()->setBorderStyle(\PHPExcel_Style_Border::BORDER_THIN);  
	...
	public function get_non_life($non_life_sign,$file_name){
        ...
        $objPHPExcel = new \PHPExcel();
        $objPHPExcel->getActiveSheet(0)->setCellValue('A1', "保单号");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('B1', "供应商");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('C1', "产品名称");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('D1', "规模保费");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('E1', "签约比例");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('F1', "代理费");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('G1', "客户姓名");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('H1', "投保日期");//设置列的值

        /*设置居中*/
        $objPHPExcel->getActiveSheet(0)->getStyle('A1:H1')->getAlignment()->setHorizontal(\PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        /*设置字体*/
        $objPHPExcel->getActiveSheet(0)->getStyle('A1:H1')->getFont()->setName('微软雅黑'); 
        /*设置行高*/
        $objPHPExcel->getActiveSheet(0)->getRowDimension(1)->setRowHeight(30);
        ...
        $objPHPExcel->getActiveSheet(0)->getColumnDimension('F')->setWidth(12);
        $objPHPExcel->getActiveSheet(0)->getColumnDimension('G')->setWidth(16);
        $objPHPExcel->getActiveSheet(0)->getColumnDimension('H')->setWidth(16);
        ...
        $i = $i-1;
        /*设置表格边框*/
        $objPHPExcel->getActiveSheet(0)->getStyle('A1:H'.$i)->getBorders()->getAllBorders()->setBorderStyle(\PHPExcel_Style_Border::BORDER_THIN); 
	...
	public function get_renewal($renewal_sign,$file_name){
        ...
        $objPHPExcel->getActiveSheet(0)->setCellValue('B1', "供应商");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('C1', "产品名称");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('D1', "应收保费");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('E1', "实收保费");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('F1', "承保日期");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('G1', "续保日期");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('H1', "续期年数");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('I1', "签约比例");//设置列的值
        $objPHPExcel->getActiveSheet(0)->setCellValue('J1', "结算保费");//设置列的值
        ...
        $objPHPExcel->getActiveSheet(0)->getColumnDimension('E')->setWidth(12);
        $objPHPExcel->getActiveSheet(0)->getColumnDimension('F')->setWidth(12);
        $objPHPExcel->getActiveSheet(0)->getColumnDimension('G')->setWidth(12);
        $objPHPExcel->getActiveSheet(0)->getColumnDimension('H')->setWidth(12);
        $objPHPExcel->getActiveSheet(0)->getColumnDimension('I')->setWidth(12);
		$objPHPExcel->getActiveSheet(0)->getColumnDimension('J')->setWidth(12);
    ...
    public function get_check_prepara_result(){
     ...
     /*浏览器输出*/
        $filename = $file_name."筹备期考核结果表_".time().'.xls';
     ...
     * @return [type] [description]
     */
    public function get_check_business_result(){
       ...
       //echo 'http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER["SERVER_PORT"].$_SERVER["REQUEST_URI"];exit;
        ...
        if($param['condition']!=0) {    //分公司
            $condition['cw.branch_shop_number'] =$param['condition'];
        }


        if($param['shop_number']!=0) {        //店铺代码
            $condition['cw.shop_number'] =$param['shop_number'];
        }
        if($param['shop_type']!=0) {        //店铺类型
            $condition['cw.shop_type'] =$param['shop_type'];
        }else{
            $condition['cw.shop_type'] = array('neq',1) ; //将分公司从查询表中剔除
        }

        $condition['cw.check_type'] = array('eq',1) ; //查询考核预警表是考核结果的数据
        $condition['cw.shop_stage'] = array('neq',0) ; //筹备类型店铺
        $check_warning_obj = M('check_warning');
        if($param['date_scope']!=0) {

            $condition['cw.check_time'] = array('eq',$param['date_scope']);
        }else{
             $max_check_time = $check_warning_obj->table("check_warning as cw")
                                                ->where($condition)
                                                ->max('check_time');        //查询表中考核时间最大的 即最新数据
        }



        if(!empty($max_check_time)){
            $condition['cw.check_time'] = array('eq',$max_check_time);
        }

        if($param['mode']>-1) {    //店铺状态

            $condition['org.check_results'] = $param['mode'];
        }


        $check_warning_result = $check_warning_obj ->table("check_warning as cw")
                                      ->join("organization as org on cw.shop_number = org.org_code")
                                      ->where($condition)
                                      ->field('cw.shop_number,cw.shop_name,cw.shop_type,cw.shop_stage,cw.achievement_target ,cw.achievement_target_reached ,cw.achievement_target_gap ,cw.direct_recom_people ,cw.direct_recom_people_reached ,cw.direct_recom_people_gap ,cw.sub_manpower ,cw.sub_manpower_reached ,cw.sub_manpower_gap ,cw.direct_recom_shop ,cw.direct_recom_shop_reached ,cw.direct_recom_shop_gap ,cw.continuation_rate ,cw.continuation_rate_rea ,cw.continuation_rate_gap ,cw.check_status ,id')
       ...
       // dump($data);exit;
        ...
        $objPHPExcel ->getActiveSheet(0)->setTitle("经营期考核结果");
     /*浏览器输出*/
        $filename = $file_name."经营期考核结果表_".time().'.xls';
       /* header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
        header('Content-Disposition: attachment;filename="'.$filename.'.xlsx"');
        header('Cache-Control: max-age=0');
        $objWriter = \PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
